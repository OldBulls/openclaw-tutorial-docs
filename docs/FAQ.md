---
title: FAQ · 高频问题速查
description: OpenClaw 实战手册 20 个最高频问题速查，涵盖安装、升级、记忆、Agent 协作和付费模板常见疑问。
---
...
### Q5：付费档位 2 卖什么？
可直接 install 的模板包（38 章公开教程配套的 SOUL / AGENTS / 维护脚本骨架）+ 1v1 答疑。详见 [chengzhen.vip](https://chengzhen.vip)。
