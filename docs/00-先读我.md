...
```bash
# 1. 装 CLI（需要 Node 22.10+；教程当前稳定基线为 2026.4.24）
...
本教程基于 **OpenClaw 2026.4.24 稳定基线** 持续更新，最后更新 **2026-05-02**。
...
> 2026-05-02 更新说明：最近几版模板把交付基线收回到 OpenClaw `2026.4.24`，并补齐安装包签名校验、在线安全更新、gateway 服务路径自愈、memory-lancedb-pro 本地补丁和 housekeeper 巡检。想看新增能力路线图，先读 [07-实战/00-最近新增能力总览](./07-实战/00-最近新增能力总览.md)。
